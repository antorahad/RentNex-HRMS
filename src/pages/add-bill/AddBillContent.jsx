...
const AddBillContent = () => {
    ...
    const handleAddBill = e => {
        ...
        const newBill = {
            billingmonth, date, name, teantemail, contact, floor, unit, houserent, electricity, water, gas, servicecharge, total, billstatus, email
        }
    ...
    return (
        <div className="w-full px-5 py-10 max-w-7xl mx-auto">
            ...
            <form onSubmit={handleAddBill} className="w-full lg:w-3/4 mx-auto bg-bodyColor bg-opacity-80 rounded-md p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <input type="submit" className="btn btn-block col-span-1 md:col-span-2 outline-none border-none bg-primeColor hover:bg-primeColor focus:bg-primeColor text-white rounded-md" value="Add Bill" />
            </form>
        </div>
    );
};
