        ...
        <div className="px-5 py-10 w-full max-w-7xl mx-auto">
            ...
            <form onSubmit={handleHouse} className="w-full lg:w-3/4 mx-auto bg-bodyColor bg-opacity-80 rounded-md p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="form-control">
                    ...
                    <input type="text" name="house" placeholder="Enter house name" className="input rounded-md" />
                </div>
                <div className="form-control">
                    <label className="label">
                        <span className="label-text text-primeColor font-bold">House Area (Square Feet)*</span>
                    </label>
                    <input type="text" name="area" placeholder="Enter house area" className="input rounded-md" />
                </div>
                <div className="form-control">
                    <label className="label">
                        <span className="label-text text-primeColor font-bold">Floor No*</span>
                    </label>
                    <input type="number" name="floor" placeholder="Enter floor number" min={1} className="input rounded-md" />
                </div>
                <div className="form-control">
                    <label className="label">
                        <span className="label-text text-primeColor font-bold">Unit No*</span>
                    </label>
                    <input type="number" name="unit" placeholder="Enter unit number" min={1} className="input rounded-md" />
                </div>
                <div className="form-control col-span-1 md:col-span-2">
                    <label className="label">
                        <span className="label-text text-primeColor font-bold">House Location*</span>
                    </label>
                    <textarea type="text" name="address" placeholder="Enter your location" className="textarea rounded-md h-24" />
                </div>
